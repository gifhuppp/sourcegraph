...
class ServerAdminWrapper {
    ...
    public trackPageView(
        ...
        logEvent(eventAction, eventProperties, publicEventProperties)
    }

    public trackAction(eventAction: string, eventProperties?: any, publicEventProperties?: any): void {
        if (this.isAuthenicated) {
