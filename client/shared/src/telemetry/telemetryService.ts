...
export interface TelemetryService {
     ...
     */
    log(eventName: string, eventProperties?: any, publicEventProperties?: any): void
    /**
     * Log a pageview event (by sending it to the server).
     */
    logViewEvent(eventName: string, eventProperties?: any, publicEventProperties?: any): void
}
